...
type IntegrationValidateConfigResp struct {
	...
	ReposUrls            []string `protobuf:"bytes,2,rep,name=repos_urls,json=reposUrls,proto3" json:"repos_urls,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *IntegrationValidateConfigResp) GetReposUrls() []string {
	if m != nil {
		return m.ReposUrls
	}
	return nil
...
type ExportGitRepoPR struct {
	...
	LastCommitSha        string   `protobuf:"bytes,3,opt,name=last_commit_sha,json=lastCommitSha,proto3" json:"last_commit_sha,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_bf10f51bd2cb5547 = []byte{
	...
	,
}
