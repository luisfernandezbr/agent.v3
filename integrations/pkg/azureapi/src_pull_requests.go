...
func (api *API) FetchPullRequests(repoids []string, fromdate time.Time, prchan chan<- datamodel.Model, prrchan chan<- datamodel.Model, prcchan chan<- datamodel.Model) error {
