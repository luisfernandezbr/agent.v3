...
func (s *Integration) exportPullRequestsRepo(logger hclog.Logger, repo api.Repo, pullRequestSender *objsender2.Session, pullRequests chan []api.PullRequest, lastProcessed time.Time) error {
