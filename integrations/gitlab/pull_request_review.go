...
func (s *Integration) exportPullRequestsReviews(logger hclog.Logger, sender *objsender.NotIncremental, repo api.Repo, pullRequests chan []api.PullRequest) error {
...
func (s *Integration) exportPullRequestReviews(logger hclog.Logger, sender *objsender.NotIncremental, repo api.Repo, pr api.PullRequest) error {
