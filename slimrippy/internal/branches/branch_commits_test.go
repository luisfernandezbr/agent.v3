...
func TestProcessBranchBasic1(t *testing.T) {
	...
	got, branchedFrom, err := branchCommits(gr, "m1", cache, "b1")
	if err != nil {
		t.Fatal(err)
	}
...
func TestProcessBranchMerged1(t *testing.T) {
	...
	got, branchedFrom, err := branchCommits(gr, "m2", cache, "b2")
	if err != nil {
		t.Fatal(err)
	}
...
func TestProcessBranchSeparateRoot(t *testing.T) {
	...
	cache := newReachableFromHead(gr, "m1")
	got, branchedFrom, err := branchCommits(gr, "m1", cache, "b2")
	if err != nil {
		t.Fatal(err)
	}
	assertCommits(t, got, []string{"b1", "b2"})
...
func TestProcessBranchMultiBranch(t *testing.T) {
	...
	cache := newReachableFromHead(gr, "m1")
	got, branchedFrom, err := branchCommits(gr, "m1", cache, "d1")
	if err != nil {
		t.Fatal(err)
	}
...
func TestProcessBranchMultiSource(t *testing.T) {
	...
	got, branchedFrom, err := branchCommits(gr, "m4", cache, "b1")
	if err != nil {
		t.Fatal(err)
	}
	assertCommits(t, got, []string{"b1"})
...
func TestProcessBranchDups(t *testing.T) {
	...
	cache := newReachableFromHead(gr, "m1")
	got, branchedFrom, err := branchCommits(gr, "m1", cache, "b4")
	if err != nil {
		t.Fatal(err)
	}
